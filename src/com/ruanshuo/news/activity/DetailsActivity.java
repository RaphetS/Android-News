...
import com.ruanshuo.news.http.NewDetailJson;
import com.ruanshuo.news.utils.Options;
import com.ruanshuo.news.utils.StringUtils;
import com.ruanshuo.news.view.HtmlTextView;
import com.ruanshuo.news.view.ProgressPieView;
...
public class DetailsActivity extends BaseActivity implements ImageLoadingListener, ImageLoadingProgressListener {
	...
	public void getResult(String result) {
		...
		if (newDetailModle == null)
			return;
		Log.e("newDetailModle>>>>>", newDetailModle.toString());
