...
import com.ruanshuo.news.view.flipview.OverFlipper;
import com.ruanshuo.news.view.flipview.OverFlipperFactory;
import com.ruanshuo.news.view.flipview.Recycler.Scrap;
	...
	public boolean onInterceptTouchEvent(MotionEvent ev) {
		...
		case MotionEvent.ACTION_MOVE:
			...
			if ((mIsFlippingVertically && yDiff > mTouchSlop && yDiff > xDiff)
				...
				if ((mIsFlippingVertically && xDiff > mTouchSlop) || (!mIsFlippingVertically && yDiff > mTouchSlop)) {
			...
			if (mIsFlipping) {
				...
				if (isOverFlipping) {
					...
					if (mOnOverFlipListener != null) {
						...
						mOnOverFlipListener.onOverFlip(this, mOverFlipMode, overFlip < 0, Math.abs(overFlip),
