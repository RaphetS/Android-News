...
public class ProgressButton extends CompoundButton {
	...
	private void init(Context context, AttributeSet attrs, int defStyle) {
		...
		int shadowDrawable = a.getResourceId(R.styleable.ProgressButton_shadowDrawable1,
	...
	protected void onDraw(Canvas canvas) {
		...
		if (mAnimating) {
			canvas.drawArc(mTempRectF, -90 + (360 * mAnimationProgress / mMax), mAnimationStripWidth, true,
					mProgressPaint);
		}
